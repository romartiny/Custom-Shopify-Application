...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Custom-Admin-Application'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '6b2e6faf7ee2fda9fb08feeeae4393c6'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '077731cd4ea65a743fb0649000aef9d7'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_checkouts,
    read_content,read_customers,read_draft_orders,read_files,read_marketing_events,read_orders,
    read_shopify_payments_disputes,read_themes,read_order_edits'),
