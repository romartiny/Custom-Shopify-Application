                            ...
                            <div class="row">
                                <div class="col-xs-7">
                                    ...
                                    <button class="btn btn-primary"
                                            onclick="exportTableToTXT('staffLogs')">Export
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="table-wrapper-scroll-y my-custom-scrollbar">
                            <table class="table table-striped table-hover" id="tableLog">
                                ...
                                <tr>
                                    ...
                                    <th class="main-item" onclick="sorting(logs, 1)">Date</th>
                                    <th class="main-item" onclick="sorting(logs, 2)">Author</th>
                                    <th class="main-item" onclick="sorting(logs, 3)">Operation</th>
